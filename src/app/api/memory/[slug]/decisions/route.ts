 ...
 * Read agent decisions memory file
 */
export async function GET(
  ...
  try {
    ...
    const content = await readMemory(slug, "decisions.md");
...
/**
 * PUT /api/memory/:slug/decisions
 * Write/update agent decisions memory file
 */
export async function PUT(
  ...
  try {
    ...
    await writeMemory(slug, "decisions.md", body.content);
